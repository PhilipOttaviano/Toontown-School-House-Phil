...
SuitAttributes = {'f': {'name': TTLocalizer.SuitFlunky, # cog name
 ...
 'ms': {'name': TTLocalizer.SuitMoverShaker,
        ...
        'level': 4,
        'hp':(SuitHPValues[4], SuitHPValues[5], SuitHPValues[6], SuitHPValues[7], SuitHPValues[8], SuitHPValues[9], SuitHPValues[10], SuitHPValues[11]),
        'def':(SuitDefValues[4], SuitDefValues[5], SuitDefValues[6], SuitDefValues[7], SuitDefValues[8], SuitDefValues[9], SuitDefValues[10], SuitDefValues[11]),
        'freq':(50,30,10,5,5,5,5,5),
        'acc':(35,40,45,50,55,60,65,70),
        'attacks':
                (('BrainStorm',
                    (5,6,8,10,12,15,18,21),
                    (60,75,80,85,90,90,90,90),
                    (15,15,15,15,15,15,15,15)),
                ('HalfWindsor',
                    (6,9,11,13,16,19,21,24),
                    (50,65,70,75,80,80,85,85),
                    (20,20,20,20,20,20,20,20)),
                ('Quake',
                    (9,12,15,18,21,23,27,30),
                    (60,65,75,80,85,85,85,85),
                    (20,20,20,20,20,20,20,20)),
                ('Shake',
                    (6,8,10,12,14,16,19,21),
                    (70,75,80,85,90,90,90,90),
                    (25,25,25,25,25,90,90,90)),
                ('Tremor',
                    (5,6,7,8,9,12,15,17),
 ...
 'ls': {'name': TTLocalizer.SuitLoanShark,
        ...
        'attacks':
                ...
                ('WriteOff',
                    ...
                    (80,80,80,85,85,90,90,95,95),
                    (15,15,15,15,15,15,15,15,15)))},
 'qm': {'name': "Quarter Master",
        'singularname': "a Quarter Master",
        'pluralname': "Quarter Masters",
        'level': 6,
        'hp':(SuitHPValues[6], SuitHPValues[7], SuitHPValues[8], SuitHPValues[9], SuitHPValues[10], SuitHPValues[11], SuitHPValues[12], SuitHPValues[13], SuitHPValues[14]),
        'def':(SuitDefValues[6], SuitDefValues[7], SuitDefValues[8], SuitDefValues[9], SuitDefValues[10], SuitDefValues[11], SuitDefValues[12], SuitDefValues[13], SuitDefValues[14]),
        'freq':(50,30,10,5,5),
